...
- **Repository evidence:** public [github.com/thuanlyt/osblog](https://github.com/thuanlyt/osblog), `main` at `691032738a245d7c33065cd292b531a5ed928d1e`, local/remote heads match; `dist/` and `node_modules/` ignored; staged diff and secret scan clean.
