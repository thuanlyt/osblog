...
- **Repository evidence:** public [github.com/thuanlyt/osblog](https://github.com/thuanlyt/osblog), SHA correction at main commit `7d4d79afd22c1950476678061d7e7732a2ef2459`, local/remote heads matched during correction audit; `dist/` and `node_modules/` ignored; staged diff and secret scan clean.
