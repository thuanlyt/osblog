...
# Assignment UA-0070: Audit slug history redirect strategy
...
- `AGENTS.md`
- `knowledge/INDEX.md`
- `work/items/UA-0070.md`

## Required report

Run `python tools/useagent.py task report UA-0070 --agent supervisor --result completed --summary "..." --next-action "Review"`.
Include changed files, checks/evidence and blockers. The supervisor will review before done.

## Assignment path

`work/agents/supervisor/inbox/UA-0070.md`
