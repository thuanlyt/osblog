...
**Trạng thái hiện tại (2026-09-05): deployment production trên Vercel đã live và được xác minh.** Deployment liên kết GitHub trên `main` kết nối với Neon và phục vụ cả hai hostname yêu cầu. Adapter Netlify đã được xây dựng nhưng chưa từng deploy; VPS vẫn là target đã viết tài liệu nhưng chưa chạy thực tế.
